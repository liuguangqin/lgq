    ...
    <script type="text/javascript">
        ...
        $(function () {
           $("#addEmp").click(function () {
               window.location.href="/deptslist.action";
           })
        });


        $(function () {
            $("button[id=deleteEmp]").click(function () {
                     var eid="";
                ...
                $.ajax({
                        type:"post",
                        url:"${pageContext.request.contextPath}/empLocked.action", //传送地址
                        contentType : "application/json;charset=utf-8",
                        dataType : "json",
                        data: JSON.stringify(json),
                        success:function(date){
                            window.location.href="/empList.action";
                            alert(date);
                        },
                        ...
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            <c:forEach items="${emps}" var="emps">
                                <tr>
                                    ...
                                    <td class="am-hide-sm-only"><img style="height: 50px;width: 40px" src="${emps.photo}">
                                    ...
                                    <td>
                                        ...
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button class="am-btn am-btn-default am-btn-xs am-text-secondary" id="edit- ${emps.eid}"><span class="am-icon-pencil-square-o"></span><a href="/empUpdatePre.action?eid=${emps.eid}">编辑</a></button>
                                            </div>
                                        </div>
