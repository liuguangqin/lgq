                ...
                <div class="am-u-sm-12 am-u-md-9">
                    <form class="am-form am-form-horizontal" action="/empUpdate.action">
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" id="eid" name="eid" placeholder="员工号 / ID" value="${vo.eid}" readonly>
                            </div>
                        </div>

                        <div class="am-form-group">
                            <label for="ename"  class="am-u-sm-3 am-form-label">员工名称/ ID</label>
                            <div class="am-u-sm-9">
                                <input type="text" id="ename" name="ename" placeholder="员工名称 / DeptId" value="${vo.ename}">
                            </div>
                        </div>
                        <div class="am-form-group">
                            <label for="did"  class="am-u-sm-3 am-form-label">部门编号 / ID</label>
                            <div class="am-u-sm-9">
                                <input type="text" id="did" name="did" placeholder="部门编号 / DeptId" value="${vo.did}">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="tel" id="lid"  name="lid" placeholder="输入要修改后的等级 / Telephone" value="${vo.lid}">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="tel" id="phone" name="phone" placeholder="输入要修改的联系电话 / Telephone" value="${vo.phone}">
                            </div>
                        </div>
