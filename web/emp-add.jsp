...
<head>
    ...
    <script src="../assets/js/dept-add.js"></script>
    <style type="text/css">
        .tips{
            color: #00e359;
            font-size: 8px
    ...
    <script type="text/javascript">
        $(function () {
            $("#eid").blur(function () {
                ...
                $.ajax({
                        type:"post",
                        url:"${pageContext.request.contextPath}/empInsertPre.action", //传送地址
             ...
             <div class="tpl-block">
                 ...
                 <div class="am-g">
                     <div class="tpl-form-body tpl-form-line">
                         <form class="am-form tpl-form-line-form" action="/empInsert.action" method="post" enctype="multipart/form-data">
                             ...
                             <div class="am-form-group">
                                 <label class="am-u-sm-3 am-form-label">登陆密码 <span class="tpl-form-line-small-title">password</span></label>
                                 <div class="am-u-sm-9">
                                     <input type="password" class="tpl-form-input" id="password" name="password" placeholder="请输入员工登陆企业系统的密码">
                                 </div>
                             </div>
                             ...
                             <div class="am-form-group">
                                 <label  class="am-u-sm-3 am-form-label">薪资 <span class="tpl-form-line-small-title">sal</span></label>
                                 <div class="am-u-sm-9">
                             ...
                             <div class="am-form-group">
                                 <label  class="am-u-sm-3 am-form-label">联系电话 <span class="tpl-form-line-small-title">phone</span></label>
                                 <div class="am-u-sm-9">
